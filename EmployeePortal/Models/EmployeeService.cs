...
namespace EmployeePortal.Models
{
    public class EmployeeService
    {
        private static List<Employee> employees = new List<Employee>
        {
            ...
            new Employee { Id = 2, FullName = "Елена Сергеевна Кузнецова", Email = "jane@example.com", Position = "Менеджер по персоналу", Department = Department.Менеджер, HireDate = DateTime.Now.AddYears(-5), DateOfBirth = DateTime.Now.AddYears(-35), Type = EmployeeType.Постоянно, Gender = "ЖЕН", Salary = 80000 },
            ...
            new Employee { Id = 6, FullName = "Ольга Николаевна Козлова", Email = "emma@example.com", Position = "Специалист по персоналу", Department = Department.Менеджер, HireDate = DateTime.Now.AddYears(-6), DateOfBirth = DateTime.Now.AddYears(-34), Type = EmployeeType.Постоянно, Gender = "ЖЕН", Salary = 75000 },
            ...
            new Employee { Id = 10, FullName = "Павел Андреевич Павлов", Email = "chris@example.com", Position = "Аналитик подбора", Department = Department.Менеджер, HireDate = DateTime.Now.AddYears(-5), DateOfBirth = DateTime.Now.AddYears(-33), Type = EmployeeType.Временно, Gender = "МУЖ", Salary = 55000 },
            ...
            new Employee { Id = 14, FullName = "Ирина Николаевна Козлова", Email = "isabella@example.com", Position = "Специалист по персоналу", Department = Department.Менеджер, HireDate = DateTime.Now.AddYears(-4), DateOfBirth = DateTime.Now.AddYears(-30), Type = EmployeeType.Постоянно, Gender = "ЖЕН", Salary = 76000 },
